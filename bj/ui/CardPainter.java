...
public class CardPainter {
     ...
     * @param rank Card rank (e.g., "A", "K", "Q", "J", "10", "9", etc.)
     * @param suit Card suit (e.g., "♠", "♥", "♦", "♣")
     * @param faceDown Whether the card is face down
     */
    public static void drawCard(Graphics2D g2, int x, int y, int w, int h, String rank, String suit, boolean faceDown) {
        ...
        try {
            ...
            if (faceDown) {
                ...
                drawFaceUpCard(g2d, 0, 0, w, h, rank, suit);
            }
     ...
     */
    private static void drawFaceUpCard(Graphics2D g2, int x, int y, int w, int h, String rank, String suit) {
        ...
        Color suitColor = (suit.equals("♥") || suit.equals("♦")) ? CARD_RED : CARD_BLACK;
    ...
    public static void drawHand(Graphics2D g2, Point anchor, int cardCount, int cardWidth, int cardHeight) {
        ...
        for (int i = 0; i < cardCount; i++) {
            ...
            drawCard(g2, cardX, cardY, cardWidth, cardHeight, "", "", true);
        }
    }
     ...
     * @param g2 Graphics2D context
     * @param anchor Starting position for the first card
     * @param cards Array of card data (rank, suit, faceDown)
     */
    ...
    public static void drawHand(Graphics2D g2, Point anchor, CardData[] cards, int cardWidth, int cardHeight) {
        ...
        for (int i = 0; i < cards.length; i++) {
            ...
            drawCard(g2, cardX, cardY, cardWidth, cardHeight, card.rank, card.suit, card.faceDown);
        }
    }
    ...
    public static class CardData {
        ...
        public CardData(String rank, String suit, boolean faceDown) {
            this.rank = rank;
            this.suit = suit;
