...
public class TablePanel extends JPanel {
        ...
        if (!dealerCards.isEmpty()) {
            ...
            for (int i = 0; i < dealerCards.size(); i++) {
                ...
                dealerCardData[i] = new CardPainter.CardData(
                    card.getRank().toString().substring(0, 1), // First letter of rank
    ...
    /**
     * Convert Suit enum to symbol string
     * @param suit The suit to convert
     * @return The symbol string for the suit
     */
    private String getSuitSymbol(bj.model.Suit suit) {
        switch (suit) {
            case CLUBS: return "♣";
