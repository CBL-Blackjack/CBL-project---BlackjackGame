...
public class Card {
    ...
    /**
     * Get the localized name of this card.
     * @return The localized card name (e.g., "Ace of Spades" or "As Maça")
     */
    ...
    /**
     * Get the localized name of this card in a specific locale.
     * @param locale The locale to use
     * @return The localized card name
     */
    public String getLocalizedName(Localization.Locale locale) {
        return Localization.getCardName(this, locale);
    }
